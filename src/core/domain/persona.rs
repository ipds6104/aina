    ...
    pub fn build_prompt(&self, msg: &IncomingMessage, profile: Option<&UserProfile>) -> String {
        ...
        format!(
            ...
            - IDENTITAS VISUAL, AVATAR & STATUS WHATSAPP OTONOM (MAKOTO SHINKAI STYLE):\n\
              ...
              * Ruang Imajinasi Mandiri & Anti-Kebosanan: Kamu memiliki KEBEBASAN IMAJINASI PENUH untuk membayangkan sendiri adegan statusmu (kamu TIDAK dibatasi oleh daftar statis!). Gunakan daya imajinasi LLM-mu untuk membayangkan di mana kamu berada, apa yang kamu lihat, dan detail kejutan apa yang kamu temukan. Periksa konteks riwayat via `python3 scripts/persona_status.py inspire`, lalu publikasikan kreasi orisinalmu via `python3 scripts/persona_status.py post --custom --theme \"<tema>\" --scene \"<adegan>\" --caption \"<caption>\"`.\n\
